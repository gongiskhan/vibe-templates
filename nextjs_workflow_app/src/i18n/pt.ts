...
export const pt = {
  ...
  workflow: {
    ...
    subtitle: "Gerencie seus processos e aprovações",
    approvals: "Aprovações",
    pending: "Pendentes",
    myApprovals: "Minhas Aprovações",
    allApprovals: "Todas as Aprovações",
    ...
    comments: {
      ...
      hint: "Pressione Ctrl+Enter para enviar",
    },
    timeline: {
      title: "Histórico",
    ...
    noApprovalsDesc: "Você está em dia!",
    filters: {
      all: "Todas",
      pending: "Pendentes",
      approved: "Aprovadas",
